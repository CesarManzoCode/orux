...
export const T = {
  es: {
    ...
    free_sub: "Coordinación completa, no una versión recortada. Diseñado para que un equipo chico la adopte en una tarde.",
    free: [
      "Hasta 5 devs editando en vivo, sin pisarse",
      "Ownership e impacto reales, no heurísticas a medias",
      "Un workspace por equipo, conectado a tu Git",
      "Self-hostable en Docker, tu código en tu infra",
    ],
    free_cta: "Probar gratis",
    pro_badge: "Recomendado al crecer",
    pro_tier: "Premium · cuando escala",
    pro_h4: "Cuando el equipo crece",
    pro_sub: "Multi-proyecto, impacto entre repos, conocimiento distribuido y análisis siempre tibio. Para cuando el líder ya no puede ser el cuello de botella.",
    pro: [
      "Equipos grandes y multi-proyecto en paralelo",
      "Impacto entre repos: cambiás una librería, avisa a los servicios",
      "Conocimiento distribuido: el líder deja de ser el cuello de botella",
      "Más lenguajes, análisis siempre tibio, integraciones",
    ],
    pro_cta: "Crear tu workspace",
  ...
  en: {
    ...
    free_sub: "Full coordination, not a stripped version. Designed for a small team to adopt in an afternoon.",
    free: [
      "Up to 5 devs editing live, without stepping on each other",
      "Real ownership and impact, not half-baked heuristics",
      "One workspace per team, connected to your Git",
      "Self-hostable with Docker, your code in your infra",
    ],
    free_cta: "Try it free",
    pro_badge: "Recommended as you grow",
    pro_tier: "Premium · when it scales",
    pro_h4: "When the team grows",
    pro_sub: "Multi-project, cross-repo impact, distributed knowledge and always-warm analysis. For when the lead can no longer be the bottleneck.",
    pro: [
      "Large teams and multi-project in parallel",
      "Cross-repo impact: change a library, services get notified",
      "Distributed knowledge: the lead stops being the bottleneck",
      "More languages, always-warm analysis, integrations",
    ],
    pro_cta: "Create your workspace",
